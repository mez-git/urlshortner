      ...
      <div className="relative overflow-x-auto shadow-sm sm:rounded-lg">
        <table className="w-full  text-sm text-left rtl:text-right text-gray-500">
          <thead className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <tr className="border-b text-gray-600 bg-white text-xl">
              <td className="px-6 py-3 break-word">FullURL</td>
              <td className="px-6 py-3 ">ShortURL</td>
              <td className="px-6 py-3">Clicks</td>
