...
const FormContainer: React.FunctionComponent<IFormContainerProps> = (props) => {
  ...
  return (
    <div className="container mx-auto p-2">
      <div className="bg-banner mg-8 rounded-xl bg-cover bg-center">
            ...
            <div className="flex">
              <div className="relative w-full">
                ...
                <input
                  ...
                  required
                  className="block w-full p-4 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500 text-center"
                  value={fullUrl}
